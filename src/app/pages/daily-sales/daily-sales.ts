        ...
        <div class="card sales-card">
            ...
            <div class="filters-grid">
                <div class="filter-group">
                    ...
                    <p-datepicker class="w-full" [(ngModel)]="fromDate" dateFormat="yy-mm-dd" [readonlyInput]="true" [showIcon]="true" placeholder="Start date" />
                </div>
                <div class="filter-group">
                    <label class="filter-label">To</label>
                    <p-datepicker class="w-full" [(ngModel)]="toDate" dateFormat="yy-mm-dd" [readonlyInput]="true" [showIcon]="true" placeholder="End date" />
                </div>
