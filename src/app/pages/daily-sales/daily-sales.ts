        ...
        <div class="card">
            ...
            <div class="filters-bar">
                <div class="filter-group">
                    ...
                    <p-datepicker [(ngModel)]="fromDate" dateFormat="yy-mm-dd" [showIcon]="true" [readonlyInput]="true" placeholder="From Date" />
                </div>
                <div class="filter-group">
                    <label class="filter-label">To</label>
                    <p-datepicker [(ngModel)]="toDate" dateFormat="yy-mm-dd" [readonlyInput]="true" [showIcon]="true" placeholder="To Date" />
                </div>
