        ...
        <div class="card sales-card">
            ...
            <div class="filters-grid">
                <div class="filter-group">
                    ...
                    <p-datepicker [(ngModel)]="fromDate" view="month" dateFormat="mm/yy" [readonlyInput]="true" [showIcon]="true" placeholder="Start month" />
                </div>
                <div class="filter-group">
                    <label class="filter-label">To</label>
                    <p-datepicker [(ngModel)]="toDate" view="month" dateFormat="mm/yy" [readonlyInput]="true" [showIcon]="true" placeholder="End month" />
                </div>
...
export class MonthlySales implements OnInit {
    ...
    private getFromDate(): string {
        return this.formatLocalDate(new Date(this.fromDate.getFullYear(), this.fromDate.getMonth(), 1));
    }

    private getToDate(): string {
        return this.formatLocalDate(new Date(this.toDate.getFullYear(), this.toDate.getMonth() + 1, 0));
    }
