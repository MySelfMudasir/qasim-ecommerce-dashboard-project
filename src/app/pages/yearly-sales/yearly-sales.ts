        ...
        <div class="card">
            ...
            <div class="filters-bar">
                <div class="filter-group">
                    ...
                    <!-- <p-datepicker [(ngModel)]="fromDate" dateFormat="yy-mm-dd" [showIcon]="true" placeholder="Start date" /> -->
                    <p-datepicker [(ngModel)]="fromDate" view="year" dateFormat="yy" [readonlyInput]="true" [showIcon]="true" placeholder="Start year" />
                </div>
                <div class="filter-group">
                    <label class="filter-label">To</label>
                    <!-- <p-datepicker [(ngModel)]="toDate" dateFormat="yy-mm-dd" [showIcon]="true" placeholder="End date" /> -->
...
export class YearlySales implements OnInit {
    ...
    fromDate: Date = new Date(this.currentYear - 1, 0, 1); // 1 Jan previous year
    toDate: Date = new Date(this.currentYear, 11, 31); // 31 Dec current year;
    ...
    ngOnInit() {
        ...
        this.fromDate = new Date(currentYear - 1, 0, 1);
    ...
    loadReport() {
        ...
        this.apiService.loadReport(this.getFromDate(), this.getToDate(), this.page, this.limit).subscribe({
            ...
            error: (err) => {
                this.loading = false;
                this.hasLoaded = true;
                console.error('[DailySales] Failed to load report:', err);
                this.cd.detectChanges();
            }
        });
    }
